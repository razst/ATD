...
class FaceRec:
    ...
    def detectFaces(self,frame):
        ...
        self.moveCmdQ.put((time.time(),x,y,z))
    ...
    def consumeOrigFrame(self,q):
        ...
        while(True):
            ...
            if now-start>=1:              
                ...
                print("[INFO] approx. Actual FPS: {:.2f}".format(fps))
                frameCount=0
                start = time.time()
            q.task_done()
    ...
    def __init__(self, frameQ,cmdQ):
        ...
        wanted_image = face_recognition.load_image_file("raz1.jpg")
        ...
        for i in range(THREAD_NUM):
            p = Process(name = "finalThread",target=self.consumeOrigFrame, args=(frameQ,))
            p.start()
